...
public abstract class Player implements Comparable<Player> {
    ...
    // ***I REMOVED THE PRIVATE MODIFIER***
     ...
     */
    //YOUR CODE HERE
    // Assignement specifies this should be abstract, but then it must be
    // implemented both in Red and Blue astronauts identically. If it were
    // up to me, this method would be concretely implemented here. 
    ...
    public boolean gameOver() {
        ...
        if (impostorCount == 0) {
            ...
            // Adding exit to stop program. Technically shouldn't for the grading system but it's
            // better this way.
            System.exit(0);
            return true;
